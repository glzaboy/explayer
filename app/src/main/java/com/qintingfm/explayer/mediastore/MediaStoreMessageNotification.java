 ...
 */
public class MediaStoreMessageNotification {
    /**
    ...
    public static void notify(final Context context,
        ...
        NotificationCompat.Builder notification = buildNotification(context, exampleString, number);
...
//                        .setSummaryText("Dummy summary text"))
        ...
        if(notifyChannel!=null){
            ...
            if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
                ...
                builder.setChannelId(notifyChannel.getId());
            }
    ...
    public static NotificationChannel createNotifyChannel(){
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){

            NotificationChannel notificationChannel=new NotificationChannel("PlayerCoreNotify", "Explayer", NotificationManager.IMPORTANCE_DEFAULT);
